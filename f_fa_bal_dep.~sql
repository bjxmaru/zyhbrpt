...
select   cc.ASSET_CODE,cc.ASSET_NAME , 
  ...
  decode(aa.accyear || aa.period, '2018' || '01',
         decode(aa.newasset_flag, 1, 0, 
             decode(aa.asset_state, 'reduce', 0,  
                  decode(   bb.CATE_NAME , '房屋及建筑物' , aa.localoriginvalue , 0 ))), 0) fa_value_begin_building , 
  decode(aa.accyear || aa.period, '2018' || '01',
         decode(aa.newasset_flag, 1, 0, 
             decode(aa.asset_state, 'reduce', 0,  
                  decode(   bb.CATE_NAME , '机器设备' , aa.localoriginvalue , 0 ))), 0) fa_value_begin_machine , 
  decode(aa.accyear || aa.period, '2018' || '01',
         decode(aa.newasset_flag, 1, 0, 
             decode(aa.asset_state, 'reduce', 0,  
                  decode(   bb.CATE_NAME , '运输工具' , aa.localoriginvalue , 0 ))), 0) fa_value_begin_vehicle , 
  ...
  decode(aa.accyear || aa.period, '2018' || '01',
         decode(aa.newasset_flag, 1, 0, 
             decode(aa.asset_state, 'reduce', 0,  
                  decode(   bb.CATE_NAME , '房屋及建筑物' , aa.accudep , 0 ))), 0) fa_accu_dep_begin_building , 
  decode(aa.accyear || aa.period, '2018' || '01',
         decode(aa.newasset_flag, 1, 0, 
             decode(aa.asset_state, 'reduce', 0,  
                  decode(   bb.CATE_NAME , '机器设备' , aa.accudep , 0 ))), 0) fa_accu_dep_begin_machine , 
  decode(aa.accyear || aa.period, '2018' || '01',
         decode(aa.newasset_flag, 1, 0, 
             decode(aa.asset_state, 'reduce', 0,  
                  decode(   bb.CATE_NAME , '运输工具' , aa.accudep , 0 ))), 0) fa_accu_dep_begin_vehicle , 
  ...
  decode(aa.accyear || aa.period, '2018' || '03',
         decode(aa.newasset_flag, 1, 0, 
             decode(aa.asset_state, 'reduce', 0,  
                  decode(   bb.CATE_NAME , '房屋及建筑物' , aa.localoriginvalue , 0 ))), 0) fa_value_end_building , 
  decode(aa.accyear || aa.period, '2018' || '03',
         decode(aa.newasset_flag, 1, 0, 
             decode(aa.asset_state, 'reduce', 0,  
                  decode(   bb.CATE_NAME , '机器设备' , aa.localoriginvalue , 0 ))), 0) fa_value_end_machine , 
  decode(aa.accyear || aa.period, '2018' || '03',
         decode(aa.newasset_flag, 1, 0, 
             decode(aa.asset_state, 'reduce', 0,  
                  decode(   bb.CATE_NAME , '运输工具' , aa.localoriginvalue , 0 ))), 0) fa_value_end_vehicle , 
  ...
  decode(aa.accyear || aa.period, '2018' || '03',
         decode(aa.newasset_flag, 1, 0, 
             decode(aa.asset_state, 'reduce', 0,  
                  decode(   bb.CATE_NAME , '房屋及建筑物' , aa.accudep , 0 ))), 0) fa_accu_dep_end_building , 
  decode(aa.accyear || aa.period, '2018' || '03',
         decode(aa.newasset_flag, 1, 0, 
             decode(aa.asset_state, 'reduce', 0,  
                  decode(   bb.CATE_NAME , '机器设备' , aa.accudep , 0 ))), 0) fa_accu_dep_end_machine , 
  decode(aa.accyear || aa.period, '2018' || '03',
         decode(aa.newasset_flag, 1, 0, 
             decode(aa.asset_state, 'reduce', 0,  
                  decode(   bb.CATE_NAME , '运输工具' , aa.accudep , 0 ))), 0) fa_accu_dep_end_vehicle , 
                
                  
  decode(aa.accyear || aa.period, '2018' || '03', 0  , aa.depamount ) fa_curr_dep_end , 
  
  
  decode(aa.accyear || aa.period, '2018' || '03', 0  , decode(   bb.CATE_NAME , '房屋及建筑物'   , aa.depamount , 0 ) ) fa_curr_dep_end_building , 
  decode(aa.accyear || aa.period, '2018' || '03', 0  , decode(   bb.CATE_NAME , '机器设备'   , aa.depamount , 0 ) ) fa_curr_dep_end_machine , 
  decode(aa.accyear || aa.period, '2018' || '03', 0  , decode(   bb.CATE_NAME , '运输工具'   , aa.depamount , 0 ) ) fa_curr_dep_end_vehicle 
