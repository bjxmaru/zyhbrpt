select org_code ,org_name , end_bal_xy , end_bal_bz ,
end_bal_zy ,beg_bal_xy , beg_bal_bz , beg_bal_zy ,
end_bal_dx, beg_bal_dx
from 
(
...
bb.mze911y end_bal_dx ,  --B8	合并抵销数期末金额	数值	(dqjk03)短期借款_合并	iufo_measure_data_zzuzlhsp	mze911y
bb.m8tydq5 beg_bal_dx   --C8	合并抵销数期初金额	数值	(dqjk03)短期借款_合并	iufo_measure_data_zzuzlhsp	m8tydq5
from  IUFO_MEASPUB_0011  aa
