select  
sum(end_bal_zzs)  end_bal_zzs, 
sum(end_bal_yss)  end_bal_yss , 
sum(end_bal_sds) end_bal_sds , 
sum(end_bal_grsds) end_bal_grsds , 
sum(end_bal_cjs) end_bal_cjs , 
sum(end_bal_jyffj ) end_bal_jyffj, 
sum(end_bal_dfjyffj) end_bal_dfjyffj ,
sum(end_bal_yhs) end_bal_yhs , 
sum(end_bal_tdzzs) end_bal_tdzzs ,  
sum(end_bal_fcs) end_bal_fcs , 
sum(end_bal_jgtjjj) end_bal_jgtjjj , 
sum(end_bal_ccsys) end_bal_ccsys , 
sum(end_bal_dkdjsds) end_bal_dkdjsds , 
sum(end_bal_szys ) end_bal_szys, 
sum(end_bal_drzjxs) end_bal_drzjxs , 
sum(end_bal_ddkjxs )  end_bal_ddkjxs , 
sum(end_bal_qt ) end_bal_qt
from 
(
