 select 
 sum(FA_BEG_BAL_BUILDING) FA_BEG_BAL_BUILDING ,
 sum(FA_VAL_ADD_PUR_BUILDING) FA_VAL_ADD_PUR_BUILDING , 
 sum(FA_VAL_ADD_CONS_BUILDING) FA_VAL_ADD_CONS_BUILDING , 
 sum(FA_VAL_ADD_HB_BUILDING) FA_VAL_ADD_HB_BUILDING , 
 sum(FA_VAL_ADD_OTHER_BUILDING) FA_VAL_ADD_OTHER_BUILDING , 
 sum(FA_VAL_ADD_DD_BUILDING) FA_VAL_ADD_DD_BUILDING , 
 sum(FA_VAL_RED_BF_BUILDING) FA_VAL_RED_BF_BUILDING , 
 sum(FA_VAL_RED_QT_BUILDING) FA_VAL_RED_QT_BUILDING , 
 sum(FA_VAL_RED_DD_BUILDING) FA_VAL_RED_DD_BUILDING , 
 sum(FA_ACCU_BEG_BAL_BUILDING) FA_ACCU_BEG_BAL_BUILDING , 
 sum(FA_ACCU_ADD_JT_BUILDING) FA_ACCU_ADD_JT_BUILDING , 
 sum(FA_ACCU_ADD_PUR_BUILDING) FA_ACCU_ADD_PUR_BUILDING , 
 sum(FA_ACCU_ADD_DD_BUILDING) FA_ACCU_ADD_DD_BUILDING , 
 sum(FA_ACCU_RED_BF_BUILDING) FA_ACCU_RED_BF_BUILDING ,
 sum(FA_ACCU_RED_OTHER_BUILDING) FA_ACCU_RED_OTHER_BUILDING , 
 sum(FA_ACCU_RED_DD_BUILDING) FA_ACCU_RED_DD_BUILDING , 
 sum(FA_JZZB_BEG_BAL_BUILDING) FA_JZZB_BEG_BAL_BUILDING , 
 sum(FA_JZZB_ADD_JT_BUILDING) FA_JZZB_ADD_JT_BUILDING , 
 sum(FA_JZZB_ADD_DD_BUILDING) FA_JZZB_ADD_DD_BUILDING ,
 sum(FA_JZZB_RED_BF_BUILDING) FA_JZZB_RED_BF_BUILDING , 
 sum(FA_JZZB_RED_DD_BUILDING) FA_JZZB_RED_DD_BUILDING , 
 sum(FA_BEG_BAL_MACHINE) FA_BEG_BAL_MACHINE , 
 sum(FA_BAL_ADD_PUR_MACHINE) FA_BAL_ADD_PUR_MACHINE ,
 sum(FA_BAL_ADD_CONS_MACHINE) FA_BAL_ADD_CONS_MACHINE , 
 sum(FA_BAL_ADD_HB_MACHINE) FA_BAL_ADD_HB_MACHINE ,
 sum(FA_BAL_ADD_OTHER_MACHINE) FA_BAL_ADD_OTHER_MACHINE ,
 sum(FA_BAL_ADD_DD_MACHINE) FA_BAL_ADD_DD_MACHINE , 
 sum(FA_BAL_RED_BF_MACHINE) FA_BAL_RED_BF_MACHINE ,
 sum(FA_BAL_RED_OTHER_MACHINE) FA_BAL_RED_OTHER_MACHINE ,
 sum(FA_BAL_RED_DD_MACHINE) FA_BAL_RED_DD_MACHINE , 
 sum(FA_ACCU_BEG_BAL_MACHINE) FA_ACCU_BEG_BAL_MACHINE ,
 sum(FA_ACCU_ADD_JT_MACHINE) FA_ACCU_ADD_JT_MACHINE, 
 sum(FA_ACCU_ADD_PUR_MACHINE) FA_ACCU_ADD_PUR_MACHINE, 
 sum(FA_ACCU_ADD_DD_MACHINE) FA_ACCU_ADD_DD_MACHINE , 
 sum(FA_ACCU_RED_BF_MACHINE) FA_ACCU_RED_BF_MACHINE ,
 sum(FA_ACCU_RED_OTHER_MACHINE) FA_ACCU_RED_OTHER_MACHINE, 
 sum(FA_ACCU_RED_DD_MACHINE) FA_ACCU_RED_DD_MACHINE, 
 sum(FA_JZZB_BEG_BAL_MACHINE) FA_JZZB_BEG_BAL_MACHINE ,
 sum(FA_JZZB_ADD_JT_MACHINE) FA_JZZB_ADD_JT_MACHINE, 
 sum(FA_JZZB_ADD_OTHER_MACHINE) FA_JZZB_ADD_OTHER_MACHINE, 
 sum(FA_JZZB_RED_BF_MACHINE) FA_JZZB_RED_BF_MACHINE ,
 sum(FA_JZZB_RED_OTHER_MACHINE) FA_JZZB_RED_OTHER_MACHINE ,
 sum(FA_BEG_BAL_VEHICLE) FA_BEG_BAL_VEHICLE, 
 sum(FA_BAL_ADD_PUR_VEHICLE) FA_BAL_ADD_PUR_VEHICLE, 
 sum(FA_BAL_ADD_CONS_VEHICLE) FA_BAL_ADD_CONS_VEHICLE, 
 sum(FA_BAL_ADD_HB_VEHICLE) FA_BAL_ADD_HB_VEHICLE, 
 sum(FA_BAL_ADD_OTHER_VEHICLE) FA_BAL_ADD_OTHER_VEHICLE, 
 sum(FA_BAL_ADD_DD_VEHICLE) FA_BAL_ADD_DD_VEHICLE, 
 sum(FA_BAL_RED_BF_VEHICLE) FA_BAL_RED_BF_VEHICLE, 
 sum(FA_BAL_RED_OTHER_VEHICLE) FA_BAL_RED_OTHER_VEHICLE, 
 sum(FA_BAL_RED_DD_VEHICLE) FA_BAL_RED_DD_VEHICLE , 
 sum(FA_ACCU_BEG_BAL_VEHICLE) FA_ACCU_BEG_BAL_VEHICLE , 
 sum(FA_ACCU_ADD_JT_VEHICLE) FA_ACCU_ADD_JT_VEHICLE , 
 sum(FA_ACCU_ADD_PUR_VEHICLE) FA_ACCU_ADD_PUR_VEHICLE , 
 sum(FA_ACCU_ADD_DD_VEHICLE) FA_ACCU_ADD_DD_VEHICLE, 
 sum(FA_ACCU_RED_BF_VEHICLE) FA_ACCU_RED_BF_VEHICLE ,
 sum(FA_ACCU_RED_OTHER_VEHICLE) FA_ACCU_RED_OTHER_VEHICLE , 
 sum(FA_ACCU_RED_DD_VEHICLE) FA_ACCU_RED_DD_VEHICLE ,
 sum(FA_JZZB_BEG_BAL_VEHICLE) FA_JZZB_BEG_BAL_VEHICLE, 
 sum(FA_JZZB_ADD_JT_VEHICLE) FA_JZZB_ADD_JT_VEHICLE, 
 sum(FA_JZZB_ADD_DD_VEHICLE) FA_JZZB_ADD_DD_VEHICLE, 
 sum(FA_JZZB_RED_BF_VEHICLE) FA_JZZB_RED_BF_VEHICLE, 
 sum(FA_JZZB_RED_DD_VEHICLE) FA_JZZB_RED_DD_VEHICLE, 
 sum(FA_BAL_BEG_OTHER) FA_BAL_BEG_OTHER, 
 sum(FA_BAL_ADD_PUR_OTHER) FA_BAL_ADD_PUR_OTHER , 
 sum(FA_BAL_ADD_CONS_OTHER) FA_BAL_ADD_CONS_OTHER, 
 sum(FA_BAL_ADD_HB_OTHER) FA_BAL_ADD_HB_OTHER ,
 sum(FA_BAL_ADD_OTHER_OTHER) FA_BAL_ADD_OTHER_OTHER, 
 sum(FA_BAL_ADD_DD_OTHER) FA_BAL_ADD_DD_OTHER ,
 sum(FA_BAL_RED_BF_OTHER) FA_BAL_RED_BF_OTHER, 
 sum(FA_BAL_RED_OTHER_OTHER) FA_BAL_RED_OTHER_OTHER, 
 sum(FA_BAL_RED_DD_OTHER) FA_BAL_RED_DD_OTHER, 
 sum(FA_ACCU_BEG_BAL_OTHER) FA_ACCU_BEG_BAL_OTHER ,
 sum(FA_ACCU_ADD_JT_OTHER) FA_ACCU_ADD_JT_OTHER, 
 sum(FA_ACCU_ADD_PUR_OTHER) FA_ACCU_ADD_PUR_OTHER, 
 sum(FA_ACCU_ADD_DD_OTHER) FA_ACCU_ADD_DD_OTHER, 
 sum(FA_ACCU_RED_BF_OTHER) FA_ACCU_RED_BF_OTHER, 
 sum(FA_ACCU_RED_OTHER_OTHER) FA_ACCU_RED_OTHER_OTHER, 
 sum(FA_ACCU_RED_DD_OTHER) FA_ACCU_RED_DD_OTHER, 
 sum(FA_JZZB_BEG_BAL_OTHER) FA_JZZB_BEG_BAL_OTHER ,
 sum(FA_JZZB_ADD_JT_OTHER) FA_JZZB_ADD_JT_OTHER, 
 sum(FA_JZZB_ADD_DD_OTHER) FA_JZZB_ADD_DD_OTHER, 
 sum(FA_JZZB_RED_BF_OTHER) FA_JZZB_RED_BF_OTHER ,
 sum(FA_JZZB_RED_DD_OTHER) FA_JZZB_RED_DD_OTHER ,
 sum(fa_value_dx_building) fa_value_dx_building , 
 sum(fa_value_dx_machine) fa_value_dx_machine , 
 sum(fa_value_dx_vehicle) fa_value_dx_vehicle , 
 sum(fa_value_dx_other) fa_value_dx_other , 
 sum(fa_dep_dx_building) fa_dep_dx_building , 
 sum(fa_dep_dx_machine) fa_dep_dx_machine , 
 sum(fa_dep_dx_vehicle) fa_dep_dx_vehicle , 
 sum(fa_dep_dx_other) fa_dep_dx_other , 
 sum(fa_jz_dx_building) fa_jz_dx_building , 
 sum(fa_jz_dx_machine) fa_jz_dx_machine , 
 sum(fa_jz_dx_vehicle) fa_jz_dx_vehicle , 
 sum(fa_jz_dx_other) fa_jz_dx_other 
...
select cc.code org_code , cc.name org_name,  
       ...
       bb.m10079  fa_bal_red_dd_vehicle  ,  --d16
        ...
        0 fa_value_dx_building  , --B18	期末抵销金额房屋及建筑物	数值	(gdzc03)固定资产_合并	iufo_measure_data_gd5m9yvf	mfg7fag
        0 fa_value_dx_machine  , --C18	期末抵销金额机器设备	数值	(gdzc03)固定资产_合并	iufo_measure_data_gd5m9yvf	mycwphv
        0 fa_value_dx_vehicle  , --D18	期末抵销金额运输工具	数值	(gdzc03)固定资产_合并	iufo_measure_data_gd5m9yvf	mq8dv1l
        0 fa_value_dx_other  , --E18	期末抵销金额电子设备及其他	数值	(gdzc03)固定资产_合并	iufo_measure_data_gd5m9yvf	m3n5it7   
               
        0 fa_dep_dx_building  , --B31	期末抵销金额房屋及建筑物B31	数值	(gdzc03)固定资产_合并	iufo_measure_data_gd5m9yvf	m4htgpf
        0 fa_dep_dx_machine  , --C31	期末抵销金额机器设备C31	数值	(gdzc03)固定资产_合并	iufo_measure_data_gd5m9yvf	miuxsp1
        0 fa_dep_dx_vehicle  , --D31	期末抵销金额运输工具D31	数值	(gdzc03)固定资产_合并	iufo_measure_data_gd5m9yvf	my9zd2s
        0 fa_dep_dx_other  , --E31	期末抵销金额电子设备及其他E31	数值	(gdzc03)固定资产_合并	iufo_measure_data_gd5m9yvf	mgl5jvl  
        
        
        0 fa_jz_dx_building  , --B42	期末抵销金额房屋及建筑物B42	数值	(gdzc03)固定资产_合并	iufo_measure_data_gd5m9yvf	mednv02
        0 fa_jz_dx_machine  , --C42	期末抵销金额机器设备C42	数值	(gdzc03)固定资产_合并	iufo_measure_data_gd5m9yvf	mkai1p2
        0 fa_jz_dx_vehicle  , --D42	期末抵销金额运输工具D42	数值	(gdzc03)固定资产_合并	iufo_measure_data_gd5m9yvf	m8ijaph
        0 fa_jz_dx_other   --E42	期末抵销金额电子设备及其他E42	数值	(gdzc03)固定资产_合并	iufo_measure_data_gd5m9yvf	mrmcvt8
...
select cc.code org_code , cc.name org_name, 
       ...
       bb.m10095  fa_bal_red_dd_vehicle  ,  --D16	本年减少_运输工具_余额_待定	数值	(gdzc03)固定资产_合并	iufo_measure_data_gd5m9yvf	m10095
        ...
        bb.mfg7fag fa_value_dx_building  , --B18	期末抵销金额房屋及建筑物	数值	(gdzc03)固定资产_合并	iufo_measure_data_gd5m9yvf	mfg7fag
        bb.mycwphv fa_value_dx_machine  , --C18	期末抵销金额机器设备	数值	(gdzc03)固定资产_合并	iufo_measure_data_gd5m9yvf	mycwphv
        bb.mq8dv1l fa_value_dx_vehicle  , --D18	期末抵销金额运输工具	数值	(gdzc03)固定资产_合并	iufo_measure_data_gd5m9yvf	mq8dv1l
        bb.m3n5it7 fa_value_dx_other  , --E18	期末抵销金额电子设备及其他	数值	(gdzc03)固定资产_合并	iufo_measure_data_gd5m9yvf	m3n5it7   
               
        bb.m4htgpf fa_dep_dx_building  , --B31	期末抵销金额房屋及建筑物B31	数值	(gdzc03)固定资产_合并	iufo_measure_data_gd5m9yvf	m4htgpf
        bb.miuxsp1 fa_dep_dx_machine  , --C31	期末抵销金额机器设备C31	数值	(gdzc03)固定资产_合并	iufo_measure_data_gd5m9yvf	miuxsp1
        bb.my9zd2s fa_dep_dx_vehicle  , --D31	期末抵销金额运输工具D31	数值	(gdzc03)固定资产_合并	iufo_measure_data_gd5m9yvf	my9zd2s
        bb.mgl5jvl fa_dep_dx_other  , --E31	期末抵销金额电子设备及其他E31	数值	(gdzc03)固定资产_合并	iufo_measure_data_gd5m9yvf	mgl5jvl  
        
        
        bb.mednv02 fa_jz_dx_building  , --B42	期末抵销金额房屋及建筑物B42	数值	(gdzc03)固定资产_合并	iufo_measure_data_gd5m9yvf	mednv02
        bb.mkai1p2 fa_jz_dx_machine  , --C42	期末抵销金额机器设备C42	数值	(gdzc03)固定资产_合并	iufo_measure_data_gd5m9yvf	mkai1p2
        bb.m8ijaph fa_jz_dx_vehicle  , --D42	期末抵销金额运输工具D42	数值	(gdzc03)固定资产_合并	iufo_measure_data_gd5m9yvf	m8ijaph
        bb.mrmcvt8 fa_jz_dx_other   --E42	期末抵销金额电子设备及其他E42	数值	(gdzc03)固定资产_合并	iufo_measure_data_gd5m9yvf	mrmcvt8
