...
[SQL]
 select aa.voucher_date voucher_date , aa.voucher_date  business_date , 
  ...
  aa.amount  yuanbi_amount, aa.amount  benbi_amount  , '客商' aux1 , aa.ks_code  aux_content1 ,  '库存组织' aux2 , '1000' aux_content2
  
  
  -- , '客商' aux1 , aa.ks_code  aux_content1  --,  '库存组织' aux2 , '1000' aux_content2
